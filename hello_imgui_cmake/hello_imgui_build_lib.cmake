...
function(him_install)
    if (HELLOIMGUI_INSTALL AND NOT IOS AND NOT ANDROID)
        ...
        install(FILES ${internal_headers} DESTINATION include/hello_imgui/internal COMPONENT ClientDevelopment)

        if(CMAKE_BUILD_TYPE STREQUAL "Release")
            install(DIRECTORY ${HELLOIMGUI_BASEPATH}/hello_imgui_cmake DESTINATION share/${PROJECT_NAME} COMPONENT ClientDevelopment)
            install(DIRECTORY ${HELLOIMGUI_BASEPATH}/hello_imgui_assets DESTINATION share/${PROJECT_NAME} COMPONENT ClientDevelopment)
            if (NOT IOS AND NOT ANDROID)
                install(FILES ${HELLOIMGUI_BASEPATH}/README.md DESTINATION share/${PROJECT_NAME} COMPONENT ClientDevelopment)
            endif()
        endif()
    endif()
...
function(him_add_nlohmann_json)
    if (HELLOIMGUI_USE_EXTERNAL_JSON)
        ...
        if(nlohmann_json_FOUND)
            ...
            if(HELLOIMGUI_INSTALL)
                install(FILES ${nlohmann_json_dir}/nlohmann/json.hpp DESTINATION include/nlohmann/json.hpp COMPONENT ClientDevelopment)
                install(FILES ${nlohmann_json_dir}/nlohmann/json_fwd.hpp DESTINATION include/nlohmann/json_fwd.hpp COMPONENT ClientDevelopment)
            endif()
        endif()
    endif()
endfunction()
