...
static HelloImGui::DockableWindow s_nestedWindow1;
static HelloImGui::DockableWindow s_nestedWindow2;
...
//
static HelloImGui::DockableWindow s_featuresDemoWindow;
static HelloImGui::DockableWindow s_layoutCustomizationWindow;
static HelloImGui::DockableWindow s_logsWindow;
static HelloImGui::DockableWindow s_dearImGuiDemoWindow;
static HelloImGui::DockableWindow s_alternativeThemeWindow;
static HelloImGui::DockableWindow s_nestedDockspaceWindow;
    ...
    if (first)
    {
        ...
        s_nestedDockspaceWindow.GuiFunction = [] { 
            ...
            if (!hasDockableWindow && ImGui::Button("Add dockable window")) {
                ...
                static HelloImGui::DockableWindow s_newDockableWindow;
