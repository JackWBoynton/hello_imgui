...
HelloImGui provides a simple Log utility that is able to collect message and display them with a specific
widget.
...
void LogClear();
void LogGui(ImVec2 size = ImVec2(0.f, 0.f), bool minimal = false);
}  // namespace HelloImGui
