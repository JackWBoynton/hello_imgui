...
static std::string GetTempPath() { return "/"; }

static std::string GetAppUserConfigFolder() { return "/home/web_user/.config"; }

static std::string GetDocumentsPath() { return "/"; }

static std::string GetHomePath() { return "/home/web_user"; }
...
static std::string GetTempPath() { return GetAppUserConfigFolder() + "/cache"; }

static std::string GetDocumentsPath() { return GetAppUserConfigFolder(); }

static std::string GetHomePath() { return GetAppUserConfigFolder(); }
