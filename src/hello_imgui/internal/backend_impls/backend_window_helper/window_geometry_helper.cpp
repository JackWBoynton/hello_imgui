...
{
    WindowGeometryHelper::WindowGeometryHelper(WindowGeometry &geometry, bool restoreLast, HelloImGuiIniSettings::IniFilenameOrContent windowGeometryIniFilename) :
