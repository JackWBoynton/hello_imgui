...
function(_add_imgui_test_engine_lib)
    ...
    if(HELLOIMGUI_INSTALL)
        ...
        install(FILES ${te_headers} DESTINATION include/imgui_test_engine COMPONENT Development)
        install(DIRECTORY ${te_source_folder}/thirdparty DESTINATION include COMPONENT Development)
    endif()
